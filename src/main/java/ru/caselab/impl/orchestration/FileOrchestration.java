...
public class FileOrchestration {
    ...
    public CreateFileResponse orchestrate(CreateFileRequestMeta meta) {
        return handler.createFile(meta);
    }

    public GetFileResponse orchestrate(GetFileRequestMeta meta) {
        return handler.getFile(meta);
    }
}
